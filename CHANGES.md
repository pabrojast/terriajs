...
- Edit legend entries for COG layers directly from the Edit Style panel (per-item colors/labels/values, add/remove rows, and toggle back to the automatic legend at any time).
